...
import java.util.*;
		...
		// do methods first and then declare the following
		...
		System.out.print("Books and Copies: \n");
		System.out.println();
		for (int i = 0; i < name.length; i++) {
			System.out.print(name[i] + " - " + qty[i] + "\n");
		}
		...
		System.out.println("Unavailable: " + outstock);
		
		System.out.println();
		
		System.out.println("To view summary, refer to text file Library Report");
